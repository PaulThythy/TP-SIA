...
//----------------------------------------
{
  ...
  glutCreateWindow("EXERCICE SSBO");
...
void traceObjet()
{
  ...
  // Le nombre de sommets à dessiner correspond au nombre d'indices stockés
  const int numIndices = NB_R * NB_r * 6;
